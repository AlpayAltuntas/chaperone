...
the real run reports 37 findings across all 24 checks):
...
HIGH (14)
  ...
  ... 13 more high-severity findings ...

MEDIUM (15)  LOW (1)  ...

Summary: 37 findings (3 critical, 14 high, 15 medium, 1 low, 4 info)
Inspected 13 paths, skipped 0.
```
...
Chaperone runs 24 checks across six categories — secrets & credential
